...
# Confirmed cases
# extract headers
head -2 time_series-ncov-Confirmed.csv  >confirmed_cases_metr_france.csv
...
# Death cases  
# extract headers
head -2 time_series-ncov-Deaths.csv  >death_cases_metr_france.csv
...
# Death cases  
# extract headers
head -2 time_series-ncov-Recovered.csv  >recovered_cases_metr_france.csv
